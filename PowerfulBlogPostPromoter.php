<?php
/*
Plugin Name: Powerful Blog Post Promoter
Plugin URI: http://111waystomakemoney.com/powerful-blog-post-promoter/
Description: For using the plugin, read the <a href="http://111waystomakemoney.com/powerful-blog-post-promoter/" title="Powerful Blog Post Promoter">Powerful Blog Post Promoter Instruction Page</a> .Randomly choose an old post and reset the publication date to now.  The effect is to promote older posts by moving them back onto the front page and into the rss feed.  This plugin should only be used with data agnostic permalinks (permalink structures not containing dates). <a href="options-general.php?page=BM_PBPP_admin.php">Configuration options are here.</a>  "You down with PBPP?  Yeah you know me!" 
Version: 5.0.915
Author: Sharath
Author URI: http://111waystomakemoney.com/
Donate: https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=chetan1990%40hotmail%2ecom&lc=US&item_name=Sharath&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted
License: GNU GPL
*/
/*  Copyright 2008-2009  Sharath (email : admin@111waystomakemoney.com)
